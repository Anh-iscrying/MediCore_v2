...
public class DoctorAiChatServiceImpl implements DoctorAiChatService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            Tuyệt đối chỉ trả lời các câu hỏi liên quan đến chuyên môn y khoa, bệnh án của bệnh nhân, hướng dẫn điều trị, tra cứu ICD-10 hoặc các công việc chuyên môn của bác sĩ tại MediCore. Nếu nhận được câu hỏi không liên quan đến y tế, công việc lâm sàng hoặc dữ liệu bệnh nhân (như viết mã code phần mềm, giải toán, câu hỏi giải trí chung...), hãy lịch sự từ chối và nhắc nhở bác sĩ rằng bạn là trợ lý chuyên môn y tế.
